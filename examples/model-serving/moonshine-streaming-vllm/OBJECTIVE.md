...
`/v1/audio/transcriptions` contract above. Vendored vLLM code counts as "your
own code" for the purposes of the implementation notes — you may edit, prune,
or vendor parts of the checkout freely.
